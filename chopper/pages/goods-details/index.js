...
Page({
  ...
  onLoad: function (e) {
    ...
    wx.request({
      url: app.globalData.domainName + app.globalData.projectName + '/goods/detail',
      data: {
        id: e.id
      },
      success: function (res) {
  ...
  */
  ...
  reputation: function (goodsId) {
    var that = this;
    wx.request({
      url: app.globalData.domainName + app.globalData.projectName + '/goods/reputation',
      data: {
        goodsId: 1
      },
      success: function (res) {
        if (res.data.code == 200) {
          ...
          console.log(that.data.reputation.length);
        }
      }
    })
  },
